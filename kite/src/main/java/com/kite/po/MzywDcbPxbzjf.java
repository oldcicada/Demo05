...
@Entity
@Table(name = "T_MZYW_DCB_XCBDJF")
public class MzywDcbPxbzjf implements Serializable {
	...
	@Column(columnDefinition = "VARCHAR(100) COMMENT '报纸、刊物、媒体、网站名称'")
	private String bzkwmtwzmc;

	@Column(columnDefinition = "VARCHAR(8) COMMENT '刊用时间'")
	private String kysj;
	
	@Column(columnDefinition = "VARCHAR(50) COMMENT '报道类型'")
	private String bdlx;
	
	@Column(columnDefinition = "VARCHAR(100) COMMENT '新闻标题''")
	private String xwbt;
	...
	public String getBzkwmtwzmc() {
		return bzkwmtwzmc;
	}

	public void setBzkwmtwzmc(String bzkwmtwzmc) {
		this.bzkwmtwzmc = bzkwmtwzmc;
	}
