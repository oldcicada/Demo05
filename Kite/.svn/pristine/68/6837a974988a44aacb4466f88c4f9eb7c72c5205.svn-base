...
public final class gfcy_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("          \t\t\t\t            </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"submit\" value=\"  生成 \" class=\"in_sub\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"reset\" value=\"  导出  \" class=\"in_sub\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
