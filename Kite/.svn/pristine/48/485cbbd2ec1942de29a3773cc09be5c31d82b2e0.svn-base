...
<body class="skin-blue" style="height: 100% !important;">
				...
				<div class="ssjc_right_up">
					<div class="nei">
						...
						<div class="sbaz_table">
							<p>
								<span class="tiaoshijian"> 报送时间： <input type="date" name="startDate"
									id="date_time"> <i
									class="glyphicon glyphicon-calendar fa fa-calendar"
									style="top: 14px;"></i>
								</span> <span class="tiaoshijian"> 至： <input type="date" name="endDate"
									id="date_time"> <i
									class="glyphicon glyphicon-calendar fa fa-calendar"
									style="top: 14px; left: 40px;"></i>
								</span> <span>逝者姓名：<input type="text" style="width: 120px;" name="szxm"></span>
								<span>殡仪馆名称： <select class="biaoti_select" name="bygmc" id="bygmc">
	...
	<script type="text/javascript"
		src="images/pageList/shswc/xxbsCxGhjzSh.js"></script>
</body>