...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("                                    </span> \r\n");
      out.write("                   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span>标题名称：<input type=\"text\"></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span>审核结果：\r\n");
      out.write("\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"已采用\">已采用</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"未采用\">未采用</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("          \t\t\t\t            </span>\r\n");
      out.write("          \t\t\t\t            <span>提交状态：\r\n");
      out.write("\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"已提交未审核\">已提交未审核</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"已提交已审核\">已提交已审核</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"未提交\">未提交</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("          \t\t\t\t            </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span>栏目名称：\r\n");
      out.write("\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"民政专版\">民政专版</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"民政信息\">民政信息</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"门户网站\">民政网站</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("          \t\t\t\t            </span>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>生产</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>项目</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><a href=\"user/xxbsXqFxby\" target=\"frame\">查看</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"checkbox\" class=\"table_check\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>174</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>生产</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>项目</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><a href=\"user/xxbsShFxby\" target=\"frame\">审核</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"checkbox\" class=\"table_check\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>175</td>\r\n");
