				...
				<ul class="sidebar-menu">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li><a href="user/fxbXxCxQx" target="frame"><i class="fa fa-bookmark"></i>
									信息报送 (法宣办)</a></li>
							...
							<li><a href="user/xxbsCxPxbzDc" target="frame"><i class="fa fa-bookmark"></i>
									评先表彰加分报送 (督查办)</a></li>
						    <li><a href="user/xxbsCxXcbdDc" target="frame"><i class="fa fa-bookmark"></i>
									宣传报道加分报送 (督查办)</a></li>
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li><a href="user/xxbsCxZhpfDc" target="frame"><i class="fa fa-bookmark"></i>
									综合评分维护 (督查办)</a></li>
                    ...
                    <li class="treeview">
						...
						<ul class="treeview-menu">
							<li><a href="user/jssz" target="frame"><i class="fa fa-bookmark"></i>
									基数设置 (法宣办)</a></li>
							<li><a href="user/xxxx" target="frame"><i class="fa fa-bookmark"></i>
									学校和专业配置 (安置处)</a></li>
						</ul>
					</li>
