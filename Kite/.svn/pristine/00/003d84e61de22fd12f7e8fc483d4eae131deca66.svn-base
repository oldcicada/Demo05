					...
					<div class="nei">
						<div class="ssjc_ru_title">
							<span class="left_ten"> 查询条件 </span> <input type="submit"
								value="公告发布"> <input type="submit" value="公告查询">
							<div class="clear"></div>
						</div>
						<div class="sbaz_table">
							<p>
								<span class="tiaoshijian"> 开始时间： <input type="date"
									id="date_time"> <i
								...
								</span> <span>公告标题：<input type="text"></span> <span>曲线类型：
									<select class="biaoti_select">
										<option value="曲线图">曲线图</option>
										<option value="折线图">折线图</option>
										<option value="柱状图">柱状图</option>
								</select>
								</span> <span>发布状态：<input type="text"></span> <input
									type="submit" value="  查询  " class="in_sub"> <input
