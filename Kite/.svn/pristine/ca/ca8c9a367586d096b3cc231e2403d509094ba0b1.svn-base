...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("                                    </span> \r\n");
      out.write("                   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span>公告标题：<input type=\"text\"></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span>状态：\r\n");
      out.write("\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"发布\">发布</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"已发布\">已发布</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("          \t\t\t\t            </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span>发布状态：<input type=\"text\"></span> \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>电</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>项目</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><a href=\"user/ggXq\" target=\"frame\">查看详情</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"checkbox\" class=\"table_check\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>174</td>\r\n");
