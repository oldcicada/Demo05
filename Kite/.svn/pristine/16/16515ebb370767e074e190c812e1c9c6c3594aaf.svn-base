...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t\t<a href=\"\" target=\"frame\"><input type=\"submit\" value=\"信息报送\"></a>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"地上式墓穴\">地上式墓穴</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  <option value=\"生态葬式\">生态葬式</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   <option value=\"节地葬式\">节地葬式</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("          \t\t\t\t            </span>\r\n");
      out.write("          \t\t\t\t            <span>藏式名称：\r\n");
      out.write("\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>项目</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><a href=\"shswc/xxbsXqYtwyBy\" target=\"frame\">查看</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"checkbox\" class=\"table_check\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>174</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>项目</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><a href=\"shswc/xxbsBsYtwyBy\" target=\"frame\">报送</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><input type=\"checkbox\" class=\"table_check\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>174</td>\r\n");
