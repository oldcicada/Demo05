...
<script src="images/pageList/bnb/bnbXxCxJg.js" type="text/javascript"></script>
</head>
				...
				<div class="ssjc_right_up">
					<div class="nei">
						<div class="ssjc_ru_title">
							...
							<a href="user/bnbXxFbJg" target="frame"><input type="submit" value="公告发布"></a> 
							<a href="user/bnbXxCxJg" target="frame"><input type="submit" value="公告查询"></a>
							<div class="clear"></div>
						</div>
						...
						<form action="">
							<p>
								...
								<span class="tiaoshijian"> 至： <input type="date"
									id="date_time" name="endDate"> <i
									class="glyphicon glyphicon-calendar fa fa-calendar"
									style="top: 14px; left: 40px;"></i>
								</span> 
								<span>报送状态：<select id="zcbs" class="biaoti_select"
