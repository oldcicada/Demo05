...
<body class="skin-blue"  style="height: 100% !important;">
					...
					<div class="ssjc_right_up">
						<div class="nei">
							<div class="ssjc_ru_title">
								...
								<a href="" target="frame"><input type="submit" value="信息报送"></a>
								<div class="clear"></div>
							</div>
							<div class="sbaz_table">
								<p>
								   <span class="tiaoshijian"> 报送时间：
									...
									<span>殡仪馆名称：
			          					<select  class="biaoti_select" name="bygmc">
										 <option value="0">合肥市殡仪馆</option>
										</select>
          				            </span>
									...
									<input type="reset" id="reset" value="  重置  " class="in_sub">
								</p>
							</div>
						</div>
	...
	<script type="text/javascript" src="images/pageList/shswc/xxbsCxSzxxSh.js"></script>
</body>