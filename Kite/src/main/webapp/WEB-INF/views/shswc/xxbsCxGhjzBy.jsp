...
<body class="skin-blue" style="height: 100% !important;">
						...
						<div class="sbaz_table">
							<p>
								<span class="tiaoshijian"> 报送时间： <input type="date"
									...
									name="szxm"></span> <span>报送状态： <select
									class="biaoti_select" name="zcbs" id="zcbs">
						...
						<div class="nei">
							...
							<div class="ssjc_rub_table">
								...
								<div class="t_fanye sbaz_table" id="pageControl">
									...
									<p>
										<span> 每页显示 <select class="biaoti_select" id="pageSize">
												<option>5</option>
												<option>8</option>
												<option>10</option>
										</select>条,跳转至第 <input type="text" style="width: 40px; height: 20px;"
											name="pageTo" id="pageTo" /> 页
										</span>
									</p>
									<div class="clear"></div>
								</div>
	...
	<script type="text/javascript"
		src="images/pageList/shswc/xxbsCxGhjzBy.js"></script>
</body>