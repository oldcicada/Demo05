					...
					<div class="nei">
						<div class="ssjc_ru_title">
							<span class="left_ten"> 查询条件 </span> <input type="submit"
								value="养老服务设施维护"> <input type="submit" value="信息查询">
							<div class="clear"></div>
						</div>
						<div class="sbaz_table">
							<p>
								<span class="tiaoshijian"> 报送时间： <input type="date"
									id="date_time"> <i class="glyphicon glyphicon-calendar fa fa-calendar"
									style="top: 14px;"></i>
								</span> 
								<span class="tiaoshijian"> 至： <input type="date"
								 ...
								 <span>报送单位：<input type="text"></span> 养老服务站名称<span>：<input
								...
								<table class="tj_table" style="border: 0">
									...
									<tbody>
										<tr>
											...
											<td>2015-02-01</td>
											<td>2015-02-01</td>
											<td><a href="views/fcc_xxbs_cx_yljg_qx/xxbsXqSqylFc">查看</a></td>
										</tr>
									</tbody>
