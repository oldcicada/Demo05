...
<script type="text/javascript">
	function startTime() {
		...
		m = checkTime(m);
		s = checkTime(s);
		document.getElementById("nowTime").innerHTML = y + "-" + M + "-" + d
				+ "  " + h + ":" + m + ":" + s;
	...
	<div class="wrapper">
		<header class="main-header">
			...
			<nav class="navbar navbar-static-top" style="position: relative;">
				<a href="#" class="sidebar-toggle" data-toggle="offcanvas"
					role="button"></a>
				<div class="all_title"
					style="width: 300px; height: 50px; display: inline-block; float: left;">合肥市民政业务管理系统</div>
				<div style="margin-left: 150px; display: inline-block; float: left;">
					<iframe allowtransparency="true" frameborder="0" width="575"
						height="77" scrolling="no"
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li><a href="user/tzggCx" target="frame"> <i
							class="fa fa-home" style="font-size: 22px"></i> <span>通知公告管理</span>
					</a></li>

					<li class="treeview"><a> <i class="fa fa-commenting-o"></i>
						...
						<ul class="treeview-menu">
							...
							<li><a href="user/xxbsCxSzxxSh" target="frame"><i
									class="fa fa-bookmark"></i> 逝者信息报送(社会事务处)</a></li>
							<li><a href="user/xxbsCxGhjzSh" target="frame"><i
									class="fa fa-bookmark"></i> 骨灰江葬报送 (社会事务处)</a></li>
							<li><a href="user/xxbsCxYtwySh" target="frame"><i
									class="fa fa-bookmark"></i> 遗体外运报送 (社会事务处)</a></li>
							<li><a href="user/xxbsCxMzxxSh" target="frame"><i
									class="fa fa-bookmark"></i> 墓葬信息报送 (社会事务处)</a></li>
							<li><a href="user/bnbXxCxJg" target="frame"><i
									class="fa fa-bookmark"></i> 信息报送 (不能办)</a></li>

						</ul></li>
					<li class="treeview"><a href="#"> <i
							class="fa fa-bar-chart"></i> <span>统计报表 (区法宣办)</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li><a href="user/gftj" target="frame"><i
									class="fa fa-bookmark"></i> 稿费统计表</a></li>
							<li><a href="user/gfcy" target="frame"><i
									class="fa fa-bookmark"></i> 稿费采用明细统计报表</a></li>
							<li><a href="user/jgcs" target="frame"><i
									class="fa fa-bookmark"></i> 机关处室年度投稿统计表</a></li>
						</ul></li>
					...
					<li class="treeview"><a href="#"> <i class="fa fa-wrench"></i>
						...
						<ul class="treeview-menu">
							<li><a href="user/xxbsCxZhpfDc" target="frame"><i
									class="fa fa-bookmark"></i> 综合评分维护 (督查办)</a></li>
							<li><a href="user/xxbsWhYljgFc" target="frame"><i
									class="fa fa-bookmark"></i> 养老机构维护 (福慈处)</a></li>
							<li><a href="user/xxbsWhSqylFc" target="frame"><i
									class="fa fa-bookmark"></i> 养老服务设施维护 (福慈处)</a></li>
						</ul></li>

					<li class="treeview"><a href="#"> <i class="fa fa-gears"></i>
							<span>参数配置</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li><a href="user/jssz" target="frame"><i
									class="fa fa-bookmark"></i> 基数设置 (法宣办)</a></li>
							<li><a href="user/xxxx" target="frame"><i
									class="fa fa-bookmark"></i> 学校和专业配置 (安置处)</a></li>
						</ul></li>
		...
		<div class="content-wrapper">
			...
			<div class="content qqq">
				<iframe width="100%" name="frame" height="100%" frameborder=0
					src="user/tzggCx"></iframe>
			</div>
		</div>
