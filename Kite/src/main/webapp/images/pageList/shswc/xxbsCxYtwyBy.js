			...
			function(data,status){
				...
				if(status){
					...
					for(var i=0;i<list.length;i++){
						...
						+"</td><td>" +list[i].gx+"</td>";
						if(list[i].zcbs=="已报送"){
							content+="<td class='text-center'><a href='user/xxbsXqYtwyBy?id="+list[i].id+"'> 查看 </a></td></tr>";
						}else{
							content+="<td class='text-center'><a href='user/xxbsBsYtwyBy?id="+list[i].id+"'>报送  </a>"
							+"<a href='user/xxbsScYtwyBy?id="+list[i].id+"'> 删除</a></td></tr>";
						}
