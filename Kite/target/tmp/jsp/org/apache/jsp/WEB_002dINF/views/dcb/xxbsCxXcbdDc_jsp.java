...
public final class xxbsCxXcbdDc_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\tvar bdlx=$(\"select[name=bdlx]\").val(\"\");\r\n");
      out.write("\tqueryPage();\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("\tvar bdlx=$(\"select[name=bdlx]\").val();\r\n");
      out.write("\t\r\n");
      out.write("\t$.post(\"user/xxbsCxXcbdDc\",\r\n");
      ...
      out.write("\t\t\t\t\t\t\t+\"</td><td>\"+list[i].bzkwmtwzmc\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td><td>\"+list[i].kysj\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td><td>\" +list[i].xwbt\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td><td>\" +list[i].bdlx\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td><td>\" +list[i].bssj\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td><td class='text-center'><a href='user/xxbsBsXcbdJg?id=\"+list[i].id+\"'>报送</a> \"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<a href='user/xxbsXqXcbdDc?id=\"+list[i].id+\"'>查看</a> \"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<a href='javascript:(void);'onclick='deleteXcbd(\"+list[i].id+\")'>删除</a> \"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td></tr>\";\r\n");
      ...
      out.write("\t\t\t\t\t\t\t+\"</td><td>\" +list[i].bdlx\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td><td>\" +list[i].bssj\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td><td class='text-center'><a href='user/xxbsXqXcbdDc?id=\"+list[i].id+\"'>查看</a> \"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td></tr>\";\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#content\").append(content);\t\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t<a href=\"user/xxbsBsXcbdJg\" target=\"frame\"><input type=\"submit\" value=\"信息报送\"></a>\r\n");
      ...
      out.write("        </select>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span> 报送时间： <input type=\"date\" name=\"startDate\" id=\"date_time\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</span> <span> 至： <input type=\"date\" name=\"endDate\" id=\"date_time\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</span><br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span> 报道类型 <select\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"biaoti_select\" id=\"bdlx\" name=\"bdlx\" style=\"width: 150px; height: 30px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"通讯\">通讯</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"简讯\">简讯</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"其他\">其他</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t</span> <input type=\"submit\" value=\"查询  \" id=\"query\" class=\"in_sub\"> <input\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>报纸、刊物、媒体、网站名称</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>刊用时间</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>新闻标题</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>报道类型</td>\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<script type=\"text/javascript\">\r\n");
      out.write("\tfunction deleteXcbd(id){\r\n");
      out.write("\t\tvar i = confirm(\"确认删除该条数据吗？\")\r\n");
      out.write("\t\tif(i){\r\n");
      out.write("\t\t\t$.post(\"user/deleteXcbdDc\",\r\n");
      out.write("\t\t\t\t\t{\"id\":id},\r\n");
      out.write("\t\t\t\t\tfunction(data,status){\r\n");
      out.write("\t\t\t\t\talert(data);\r\n");
      out.write("\t\t\t\t\twindow.location.href = 'user/xxbsCxXcbdDc';\r\n");
      out.write("\t\t\t});\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
