...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\" name=\"bygmc\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t <option value=\"0\">合肥市殡仪馆</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("          \t\t\t\t            </span>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"reset\" id=\"reset\" value=\"  重置  \" class=\"in_sub\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"images/pageList/shswc/xxbsCxSzxxSh.js\"></script>\r\n");
      out.write("</body>");
    } catch (Throwable t) {
