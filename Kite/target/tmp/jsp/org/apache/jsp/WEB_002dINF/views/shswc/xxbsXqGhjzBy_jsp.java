...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t<span class=\"left_ten\">骨灰江葬信息</span> \r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"user/xxbsCxGhjzBy\" target=\"frame\"><input type=\"submit\" value=\"信息查询\"></a>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"user/xxbsCxGhjzBy\"><input type=\"reset\" value=\"  返回 \" class=\"in_sub\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
