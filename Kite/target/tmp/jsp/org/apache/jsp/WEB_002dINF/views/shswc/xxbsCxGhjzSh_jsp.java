...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span class=\"tiaoshijian\"> 报送时间： <input type=\"date\" name=\"startDate\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"date_time\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"glyphicon glyphicon-calendar fa fa-calendar\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"top: 14px;\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t</span> <span class=\"tiaoshijian\"> 至： <input type=\"date\" name=\"endDate\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"date_time\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"glyphicon glyphicon-calendar fa fa-calendar\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"top: 14px; left: 40px;\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t</span> <span>逝者姓名：<input type=\"text\" style=\"width: 120px;\" name=\"szxm\"></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span>殡仪馆名称： <select class=\"biaoti_select\" name=\"bygmc\" id=\"bygmc\">\r\n");
      ...
      out.write("\t\tsrc=\"images/pageList/shswc/xxbsCxGhjzSh.js\"></script>\r\n");
      out.write("</body>");
    } catch (Throwable t) {
