...
public final class xxbsXqSzxxSh_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${szxx.szhjdmc }", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>死亡原因</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p><select class=\"biaoti_select\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 150px; height: 30px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">正常</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">非正常</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p></td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 150px; height: 30px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">城乡低保</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">农村五保</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">重点优抚对</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">非重点救助</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p></td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"\">否</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<p>合肥市殡葬基本公共服务惠民工程六项免费清单（单位：元）</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>普通车辆遗体接运费</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>普通火化炉火化费</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>骨灰存放费用</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>殡仪馆内遗体冷藏费用</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>普通骨灰盒</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>普通告别厅费用</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>");
      ...
      out.write("</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${szxx.ptgbtfy }", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" value=\" 逝者户口簿  \" class=\"in_sub\" style=\"margin-left:40px;\"> 逝者户口簿\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" value=\" 死亡证明  \" class=\"in_sub\" style=\"margin-left:40px;\"> 死亡证明\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"user/xxbsCxSzxxSh\"><input type=\"submit\" value=\"  返回 \" class=\"in_sub\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
