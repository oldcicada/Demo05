...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t\t\t逝者信息报送(殡仪馆)</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"user/xxbsCxGhjzSh\" target=\"frame\"><i class=\"fa fa-bookmark\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t骨灰江葬报送 (社会事务处)</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"user/xxbsCxGhjzBy\" target=\"frame\"><i class=\"fa fa-bookmark\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t骨灰江葬报送 (殡仪馆)</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"user/xxbsCxYtwySh\" target=\"frame\"><i class=\"fa fa-bookmark\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t遗体外运报送 (社会事务处)</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"user/xxbsCxYtwyBy\" target=\"frame\"><i class=\"fa fa-bookmark\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t遗体外运报送 (殡仪馆)</a></li>\r\n");
      out.write("\t\t\t\t\t\t    <li><a href=\"user/xxbsCxMzxxSh\" target=\"frame\"><i class=\"fa fa-bookmark\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t墓葬信息报送 (社会事务处)</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"user/xxbsCxMzxxGm\" target=\"frame\"><i class=\"fa fa-bookmark\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t墓葬信息报送 (公墓处)</a></li>\r\n");
