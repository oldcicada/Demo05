...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t<a href=\"user/xxbsAdSzxxBy\" target=\"frame\"><input type=\"submit\" value=\"新增信息报送 \" ></a>\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"user/xxbsCxSzxxBy\" target=\"frame\"><input type=\"submit\" value=\"信息查询\"></a>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"6\">逝者基本信息<input type=\"hidden\" name=\"id\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"submit\" value=\"  暂存报送 \" class=\"in_sub\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"reset\" class=\"in_sub\" value=\"  重置  \"></a></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"submit\" value=\"  新增报送  \" class=\"in_sub\" id=\"add\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      ...
      out.write("\t$(\"#add\").click(){\r\n");
      out.write("\t\t$form.attr(\"user/xxbsZcSzxxBy\");\t\r\n");
      out.write("\t}\r\n");
      out.write("\t</script>\r\n");
      out.write("</body>");
    } catch (Throwable t) {
