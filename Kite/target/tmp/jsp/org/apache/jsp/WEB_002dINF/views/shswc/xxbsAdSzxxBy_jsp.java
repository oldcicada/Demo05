...
public final class xxbsAdSzxxBy_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t<form action=\"user/xxbsAdSzxxBy\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"szswyyValue\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<!-- 具体到小时 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" required=\"required\" name=\"ytrgrq\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>火化日期</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<!-- 具体到小时 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"szhhrq\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"sfxzjzValue\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<select class=\"biaoti_select\" name=\"bygmc\" id=\"bygmc\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 150px; height: 30px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"ptclytjyf\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tpattern=\"^[0-9_]{1,5}$\" required=\"required\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<!-- 5位纯数字组合，如果打到四位数，以千分位展示；如果没有使用该项，则填写0； -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"pthhlhhf\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tpattern=\"^[0-9_]{1,5}$\" required=\"required\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"ghcffy\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tpattern=\"^[0-9_]{1,5}$\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired=\"required\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"bygnytlcfy\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tpattern=\"^[0-9_]{1,5}$\" required=\"required\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"ptghh\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tpattern=\"^[0-9_]{1,5}$\" required=\"required\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"ptgbtfy\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tpattern=\"^[0-9_]{1,5}$\" required=\"required\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>身份证号码</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"jbrsfzhm\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tpattern=\"^(\\d{6})(\\d{4})(\\d{2})(\\d{2})(\\d{3})([0-9]|X)$\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired=\"required\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>姓名</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"jbrxm\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tpattern=\"^[\\u4E00-\\u9FA5A-Za-z0-9_]{1,10}$\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired=\"required\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>联系电话</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"jbrlxdh\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"submit\" value=\"  暂存报送 \" class=\"in_sub\" id=\"submit\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"reset\" class=\"in_sub\" value=\"  重置  \"></a></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"submit\" value=\"  新增报送  \" class=\"in_sub\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      ...
      out.write("\t$(function(){\r\n");
      out.write("\t\t$.post(\"dictList\",\r\n");
      out.write("\t\t\t\t{\"dm\":\"funeral\"},\r\n");
      out.write("\t\t\t\tfunction(data,status){\r\n");
      out.write("\t\t\t\t\tif(status){\r\n");
      out.write("\t\t\t\t\t\t$(\"#bygmc\").empty();\r\n");
      out.write("\t\t\t\t\t\tvar content=\"\";\r\n");
      out.write("\t\t\t\t\t\tfor(var i=0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\t\t\tcontent+=\"<option value='\"+data[i].lxjp+\"'>\"+data[i].mc+\"</option>\";\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t$(\"#bygmc\").append(content);\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t});\r\n");
      out.write("\t$(\"#submit\").click(function(){\r\n");
      out.write("\t\t$(\"form\").attr(\"action\",\"user/xxbsAdZcSzxxBy\");\r\n");
      out.write("\t});\r\n");
      out.write("\t</script>\r\n");
      out.write("</body>");
    } catch (Throwable t) {
