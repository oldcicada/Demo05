...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" value=\"  地上式墓穴  \" class=\"in_sub\"> 地上式墓穴\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t          \t\t\t\t                  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t          \t\t\t\t                    <input type=\"checkbox\" value=\"  生态葬式  \" class=\"in_sub\"> 地上式墓穴\r\n");
      out.write("\t\t\t\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t          \t\t\t\t                   &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t          \t\t\t\t                    <input type=\"checkbox\" value=\"  节地葬式  \" class=\"in_sub\"> 地上式墓穴\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\">\r\n");
