...
public final class xxbsCxMzxxGm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("                                    <i class=\"glyphicon glyphicon-calendar fa fa-calendar\"></i>\r\n");
      out.write("                                    </span> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span>逝者姓名：<input type=\"text\" style=\"width: 120px;\" name=\"szxm\"></span><br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span>报送状态：\r\n");
      out.write("\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\" name=\"zcbs\" id=\"zcbs\">\r\n");
      out.write("\t\t\t          \t\t\t\t\t<option value=\"\">请选择</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("          \t\t\t\t            </span>\r\n");
      out.write("          \t\t\t\t            <span>葬式名称：\r\n");
      out.write("\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\" name=\"zsxz\" id=\"zsxz\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"\">请选择</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("          \t\t\t\t            </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span>身份证号码：<input type=\"text\" name=\"szsfzhm\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</select>条,跳转至第 <input type=\"text\" style=\"width:40px;height:20px;\" name=\"pageTo\" id=\"pageTo\"/> 页</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\tsrc=\"images/pageList/shswc/xxbsCxMzxxGm.js\"></script>\r\n");
      out.write("</body>");
    } catch (Throwable t) {
