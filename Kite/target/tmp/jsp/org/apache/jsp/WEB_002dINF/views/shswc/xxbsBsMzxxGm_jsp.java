...
public final class xxbsBsMzxxGm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t<a href=\"user/xxbsCxMzxxGm\" target=\"frame\"><input type=\"submit\" value=\"信息查询\"></a>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<form action=\"user/xxbsZcMzxxGm\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<table class=\"tj_table\" style=\"border: 0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"6\">逝者基本信息\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${mzxx.id }", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\" name=\"id\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</thead>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"szsfzhm\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>姓名</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"szxm\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>户籍地</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"szhjd\" value=\"");
      ...
      out.write("\" id=\"zsxz\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"zsxz\"  value=\"0\" class=\"in_sub\" id=\"first\"> 地上式墓穴\r\n");
      ...
      out.write("\t          \t\t\t\t                    \r\n");
      out.write("\t          \t\t\t\t                  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t          \t\t\t\t                    <input type=\"radio\" name=\"zsxz\" value=\"1\" class=\"in_sub\" id=\"second\"> 生态葬式\r\n");
      out.write("\t\t\t\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t          \t\t\t\t                   &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t          \t\t\t\t                    <input type=\"radio\" name=\"zsxz\" value=\"2\" class=\"in_sub\" id=\"third\"> 节地葬式\r\n");
      out.write("\t\t\t\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"mxqymcValue\" value=\"");
      ...
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<select class=\"biaoti_select\" style=\"width: 150px; height: 30px\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t name=\"mxqymc\" id=\"mxqymc\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t </select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>墓穴价格</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"mxjg\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"gmrq\" value=\"");
      ...
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tpattern=\"^[0-9-]{1,30}$\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired=\"required\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>安葬日期</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"text\" name=\"azrq\" value=\"");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"images/pageList/shswc/xxbsBsMzxxGm.js\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\">\r\n");
      out.write("\t$('#submit').click(function(){\r\n");
      out.write("\t\t\t$(\"form\").attr(\"action\",\"user/xxbsBsMzxxGm\");\r\n");
      out.write("\t});\r\n");
      out.write("\t</script>\r\n");
      out.write("</body>");
    } catch (Throwable t) {
