...
public final class xxbsXqMzxxGm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t          \t\t\t\t                  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t          \t\t\t\t                    <input type=\"radio\" name=\"zsxz\" value=\"  生态葬式  \" class=\"in_sub\" id=\"second\"> 地上式墓穴\r\n");
      out.write("\t\t\t\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t          \t\t\t\t                   &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t          \t\t\t\t                    <input type=\"radio\" name=\"zsxz\"  value=\"  节地葬式  \" class=\"in_sub\" id=\"third\"> 地上式墓穴\r\n");
      out.write("\t\t\t\t\t\t          \t\t\t\t\t<select  class=\"biaoti_select\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"user/xxbsCxMzxxGm\"><input type=\"submit\" value=\"  返回 \" class=\"in_sub\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
