...
public final class xxbsBsGhjzBy_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String baseUrl = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()
      ...
      out.write("\t\t\t\t\t\t\t<span class=\"left_ten\">骨灰江葬信息报送 </span> \r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"user/xxbsBsGhjzBy?id=");
      ...
      out.write("\"><input type=\"submit\" value=\"信息报送\" ></a>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<form action=\"user/xxbsZcGhjzBy\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<table class=\"tj_table\" style=\"border: 0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td colspan=\"6\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t逝者基本信息<input type=\"hidden\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${szxx.id }", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\" name=\"id\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\" name=\"szhjd\" \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tpattern=\"^[\\u4E00-\\u9FA5A-Za-z0-9_]{1,20}$\" required=\"required\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t$(\"form\").attr(\"action\",\"user/xxbsBsGhjzBy\");\r\n");
      out.write("\t});\r\n");
      out.write("\t</script>\r\n");
      out.write("</body>");
    } catch (Throwable t) {
